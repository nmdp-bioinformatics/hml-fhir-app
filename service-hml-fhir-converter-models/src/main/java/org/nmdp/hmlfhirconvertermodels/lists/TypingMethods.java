...
public class TypingMethods {
    private List<TypingMethod> typingMethods;

    public List<TypingMethod> getTypingMethods() {
        return typingMethods;
    }

    public void setTypingMethods(List<TypingMethod> typingMethods) {
        this.typingMethods = typingMethods;
    }
}
