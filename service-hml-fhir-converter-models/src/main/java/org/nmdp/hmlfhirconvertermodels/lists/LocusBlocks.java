...
public class LocusBlocks {
    private List<LocusBlock> locusBlocks;

    public List<LocusBlock> getLocusBlocks() {
        return locusBlocks;
    }

    public void setLocusBlocks(List<LocusBlock> locusBlocks) {
        this.locusBlocks = locusBlocks;
    }
}
