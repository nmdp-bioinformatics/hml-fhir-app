...
public class Variant extends SwaggerConverter<Variant, org.nmdp.hmlfhirconvertermodels.dto.hml.Variant> implements Serializable, ICascadable {

    private static Class<Variant> tClass = Variant.class;
    private static Class<org.nmdp.hmlfhirconvertermodels.dto.hml.Variant> uClass = org.nmdp.hmlfhirconvertermodels.dto.hml.Variant.class;
