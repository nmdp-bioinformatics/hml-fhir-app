...
public class SbtNgs extends SwaggerConverter<SbtNgs, org.nmdp.hmlfhirconvertermodels.dto.hml.SbtNgs> implements Serializable, ICascadable {

    private static Class<SbtNgs> tClass = SbtNgs.class;
    private static Class<org.nmdp.hmlfhirconvertermodels.dto.hml.SbtNgs> uClass = org.nmdp.hmlfhirconvertermodels.dto.hml.SbtNgs.class;
