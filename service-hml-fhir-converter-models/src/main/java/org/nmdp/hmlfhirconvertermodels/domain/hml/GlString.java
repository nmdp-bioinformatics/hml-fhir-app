...
public class GlString extends SwaggerConverter<GlString, org.nmdp.hmlfhirconvertermodels.dto.hml.GlString> implements Serializable, ICascadable {

    private static Class<GlString> tClass = GlString.class;
    private static Class<org.nmdp.hmlfhirconvertermodels.dto.hml.GlString> uClass = org.nmdp.hmlfhirconvertermodels.dto.hml.GlString.class;
