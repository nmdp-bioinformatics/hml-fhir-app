...
public class FhirSubmission implements Serializable {
    ...
    public List<Object> getSubmissionResult() {
        return submissionResult;
    }

    public void setSubmissionResult(List<Object> submissionResult) {
        this.submissionResult = submissionResult;
    }

    public void addSubmissionResult(List<Object> submissionResults) {
        this.submissionResult.addAll(submissionResults);
    }

    public void addSubmissionResult(Object submissionResult) {
