...
public class Sequence extends SwaggerConverter<Sequence, org.nmdp.hmlfhirconvertermodels.dto.hml.Sequence> implements Serializable, ICascadable {

    private static Class<Sequence> tClass = Sequence.class;

    private static Class<org.nmdp.hmlfhirconvertermodels.dto.hml.Sequence> uClass = org.nmdp.hmlfhirconvertermodels.dto.hml.Sequence.class;
