...
public class GenotypingResultsHaploids implements Serializable {
    private List<GenotypingResultsHaploid> genotypingResultsHaploids;

    public List<GenotypingResultsHaploid> getGenotypingResultsHaploids() {
