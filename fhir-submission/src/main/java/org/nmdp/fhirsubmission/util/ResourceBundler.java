...
public class ResourceBundler {
    ...
    protected static final String RESOURCE_TYPE_VALUE = "Bundle";
    protected static final String BUNDLE_TYPE_KEY = "type";
    protected static final String BUNDLE_TYPE_VALUE = "transaction";
    protected static final String REQUEST_METHOD_KEY = "method";
    protected static final String REQUEST_METOHD_VALUE = "POST";
    protected static final String REQUEST_URL_KEY = "url";
    protected static final String REQUEST_KEY = "request";
    protected static final String STATUS_KEY = "status";
    protected static final String STATUS_VALUE = "final";
    protected static final String SUBJECT_KEY = "subject";
    protected static final String SPECIMEN_KEY = "specimen";
    protected static final String REFERENCE_KEY = "reference";
    protected static final String RELATED_KEY = "related";
    protected static final String ENTRY = "entry";
    protected static final String RESOURCE = "resource";
    protected static final String FULL_URL = "fullUrl";
    protected static final String GUID_PREFIX = "urn:uuid:";
    protected static final String PATIENT_RESOURCE = "Patient";
    protected static final String SPECIMEN_RESOURCE = "Specimen";
    protected static final String DISPLAY_KEY = "display";
    protected static final String OBSERVATION_RESOURCE = "Observation";
    protected static final String DIAGNOSTIC_REPORT_RESOURCE = "DiagnosticReport";
    protected static final String SEQUENCE_RESOURCE = "Sequence";
    protected static final String DEVICE_RESOURCE = "Device";
    protected static final String PROVENANCE_RESOURCE = "Provenance";
    protected static final String PROCEDURE_REQUEST_RESOURCE = "ProcedureRequest";
    protected static final String RESULT_KEY = "result";
    protected static final String CODE_KEY = "code";
    protected static final String SYSTEM_KEY = "system";
    protected static final String SYSTEM_VALUE = "http://loinc.org";
    protected static final String CODE_VALUE = "51959-5";
    protected static final String CODING_KEY = "coding";
    protected static final String TYPE_KEY = "type";
    protected static final String DERIVED_FROM_VALUE = "derived-from";
    protected static final String HAS_MEMBER_VALUE = "has-member";
    protected static final String TARGET_KEY = "target";
    protected static final String VALUE_STRING_KEY = "valueString";
    protected static final String COMPONENT_KEY = "component";
    protected static final String VALUE_CODEABLE_CONCEPT_KEY = "valueCodeableConcept";
    protected static final String VALUE_KEY = "value";
    protected static final String TEXT_KEY = "text";
    protected static final String WHO_REFERENCE_KEY = "whoReference";
    protected static final String RECORDED_KEY = "recorded";
    protected static final String AGENT_KEY = "agent";
    protected static final String WHAT_IDENTIFIER_KEY = "whatIdentifier";
    protected static final String EXTENSION_KEY = "extension";
    ...
    protected static final String NOTE_KEY = "note";
    protected static final String INTENT_KEY = "intent";
    protected static final String IDENTIFIER_KEY = "identifier";

    protected static final Logger LOG = Logger.getLogger(ResourceBundler.class);
