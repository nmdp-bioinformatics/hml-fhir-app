...
import org.nmdp.kafkafhirsubmissionconsumer.handler.FhirSubmissionHandler;
...
public class ConnectorConfiguration {
    ...
    public List<KafkaMessageConsumer> createConnectors(
        ...
        FhirSubmissionHandler handler = new FhirSubmissionHandler(applicationProperties);
