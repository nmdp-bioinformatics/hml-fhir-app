...
public class RootConfiguration {
    ...
    public Map<String, List<KafkaMessageConsumer>> initConnectors(List<Closeable> closeables, MetricRegistry metrics, ApplicationProperties applicationProperties)
            throws Exception {
        ...
        for (ConnectorConfiguration conf : connectors) {
            List<KafkaMessageConsumer> connector = conf.createConnectors(
                    closeables, metrics, kafkaConfigMap, consumerDefaults, consumerGroupPrefix, applicationProperties);
